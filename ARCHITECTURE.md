...
### 7. 自律循环 ([`autonomicLoop`](qingyu-ui/app.go:538))
...
读取伙伴名字 + 记忆统计上下文
  ↓
根据时段选择思考模式:
  dawn (5-9点)   → 晨间自省: 读日记, 问"我是谁"
  night (22-5点) → 日终复盘: 写日记, 更新自我认知
  day/dusk       → 常规自律: 维护文档, 更新伙伴档案, 主动聊天
  ↓
...
- 自律 prompt 包含「伙伴档案」职责：回顾对话、提炼约定/习惯/喜好/脾气
